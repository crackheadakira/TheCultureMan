...
module.exports = {
    name: 'novel',
    description: 'This will allow you to read the finest novel in the entire world.',
    run: async (client, message, args) => {
        try {

            const novelDescription = new MessageEmbed()
                .setColor('FFBF00')
                .setTitle("After losing my virginity at a brothel at the age of 12 I was struck by a fighter plane. The Gods of the world were Futanari's who blessed me with magic that grew my cock!?")
                .setDescription("This story follows Rak Dilf. A boy who had run away from home at the age of 9. He was a pretty talented kid, he could make money for himself by scamming people as that was the thing he was best at. At the age of 12 after living on the streets for 3 years he decided to finally lose his virginity. He could only describe that night as perfect. But when he walked out of the brothel he was hit by a fighter plane. He then met the gods, who turned out to be futanari's. They gifted him magic that grew his cock and wished him luck on his journey. Follow Rak's new adventure throughout the magical country of Futaland!")

            const chapter1Part1 = new MessageEmbed()
                .setColor('FFBF00')
                .setTitle("Chapter 1 Part 1")
                .setDescription(`My name is Rak Dilf and I was abused by my parents a lot so I decided to run away and make a living as a scammer, as I was pretty much a genius in that area. After earning myself some money to have a stable income I discovered alcohol and drugs. I ate and drank those as if they were candy for a solid 3 years until on my 12th birthday when I decided to lose my virginity in a brothel.
            I had chosen the most top-class brothel there was in Hungoden, the capital of Domaliyas a country situated between Australia and Japan. The brothel had so many top-class girls it was quite difficult choosing what girl I should fuck, I felt like I was in a candy store except that it was a brothel. After a few minutes of difficult eliminations I ended up going with a girl at the age of 22 by the name of Samantha Iglias, I had heard about the Iglias family a few years ago on TV when I still hadn't run away from home. Apparently they were some rich family that had all of a sudden gone bankrupt so I can see why they'd need a job, the daughters of the family were pretty fucking beautiful so this type of job was perfect for them. The men though were probably home waiting for the girls paychecks so they could spend it all on booze.
            ...
            const chapter1Part2 = new MessageEmbed()
                .setColor('FFBF00')
                .setTitle("Chapter 1 Part 2")
                .setDescription(`She slowly got down on her knees and started to drag off my pants, she slowly stroked my cock inside of my underwear as to give me a small taste of what was to come. When she took of my underwear she was impressed by how big and stiff my cock was. She whisped her hair around to her back and slowly started to put her lips around the tip of my cock. The moment her lips touched my cock she started to use her tongue, slowly moving it from the tip to the balls. She fondled my balls a bit as if to measure how much sperm I had. She then started to suck on my cock, first slowly and then she started to go faster. I came the instant she did that.
            ...
            "W-what, why's there no data on you?"
            "What do you mean?"
            "We normally have data on everyone from Ear... oh.. I see who your parents are."
            "What do my parents have to do with this!?"
            "Well you see, they're not actually from Earth. They were originally born in a different universe in a country called Futaland. That place is so much different from Earth. Technology there isn't as advanced, and to make up for that there is magic but to keep it balanced we also created monsters."
            "Because of the fact there isn't a register of you we're forced to send you to Futaland."
            ...
            const chapter3 = new MessageEmbed()
                .setTitle("Chapter 3")
                .setColor("FFBF00")
                .setDescription("**W.I.P**")

            const pages = [novelDescription, chapter1Part1, chapter1Part2, chapter2, chapter3]
